...
const Hero = () => {
  ...
  <h1 className={`font-black lg:text-[70px] sm:text-[50px] xs:text-[40px] text-[30px] lg:leading-[80px] mt-20 text-white`}>
    Hi, I'm <p className='text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500 text-[50px] lg:text-[90px]'>Rushikesh Mishra</p>
  </h1>
</div>
</div>
<div className="sliderContainer md:z-[-10]">
  <div ref={slider} className="slider overflow-hidden text-secondary text-[50px] lg:text-[150px]">
